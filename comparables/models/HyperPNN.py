...
class HyperPNN(nn.Module):    
    ...
    def __init__(self, in_channels, mid_channels, out_channels, hp_ratio, n_select_bands, hm_ratio, n_bands):
        ...
        self.conv1 = nn.Conv2d(in_channels=self.in_channels,  out_channels=self.mid_channels, kernel_size=1)                             # in_channels
        self.conv2 = nn.Conv2d(in_channels=self.mid_channels, out_channels=self.mid_channels, kernel_size=1)
        
        self.conv3 = nn.Conv2d(in_channels=self.mid_channels+1, out_channels=self.mid_channels, kernel_size=3, padding=1, stride=1)      # mid_channels+1
        ...
        self.conv7 = nn.Conv2d(in_channels=self.mid_channels, out_channels=self.out_channels, kernel_size=1)                             # out_channels
