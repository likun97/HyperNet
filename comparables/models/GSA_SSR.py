...
# from GSA_GLP import GSA
# sys.path.remove("../utils")
import sys
sys.path.append("..")
from utils.GSA_GLP import GSA
...
class GSA_SSRNET(nn.Module): 
    ...
    def forward(self, batch_h, batch_m, batch_p):  
        ...
        return x, x_spat, x_spec, spat_edge1, spat_edge2, spec_edge            # x, spat_edge1, spat_edge2, spec_edge --- are used in SSR-Net
